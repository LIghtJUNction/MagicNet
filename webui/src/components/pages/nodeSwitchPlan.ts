...
export function nodeSwitchPlanTone(status: NodeSwitchPlan["status"]): string {
  if (status === "switch") return "border-lime-400/25 bg-lime-400/10 text-lime-100";
  if (status === "warning") return "border-red-400/30 bg-red-400/10 text-red-100";
  if (status === "keep") return "border-sky-400/25 bg-sky-400/10 text-sky-100";
