...
assert.match(webuiApi, /"replay"[\s\S]*replay_persisted_selectors\(app, true\)/);
assert.match(webuiApi, /"replay-startup"[\s\S]*replay_persisted_selectors\(app, false\)/);
assert.match(core, /api replay-startup/);
