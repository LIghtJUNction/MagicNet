...
{"name":"magicnet_service_control","description":"Run service status/start/ensure/stop/restart/toggle/logs, optionally with a target such as current, sing-box, or mihomo.","inputSchema":{"type":"object","properties":{"action":{"type":"string","enum":["status","start","ensure","stop","restart","toggle","logs"]},"target":{"type":"string"}}}},
{"name":"magicnet_core_select","description":"Select the default core.","inputSchema":{"type":"object","properties":{"core":{"type":"string","enum":["sing-box","mihomo"]}},"required":["core"]}},
{"name":"magicnet_config_apply","description":"Apply runtime config helpers.","inputSchema":{"type":"object","properties":{}}},
{"name":"magicnet_config_get","description":"Read generated mihomo or sing-box config through the config editor.","inputSchema":{"type":"object","properties":{"target":{"type":"string","enum":["mihomo","sing-box"]}},"required":["target"]}},
...
{"name":"magicnet_vpn_set","description":"Enable or disable VPN coexistence routing protection.","inputSchema":{"type":"object","properties":{"mode":{"type":"string","enum":["on","off"]}},"required":["mode"]}},
{"name":"magicnet_vpn_reload","description":"Reload VPN coexistence routing rules.","inputSchema":{"type":"object","properties":{}}},
{"name":"magicnet_tailscale_set","description":"Save and apply Tailscale shortcut config.","inputSchema":{"type":"object","properties":{"auth_key":{"type":"string"},"hostname":{"type":"string"},"subnets":{"type":"string"}}}},
{"name":"magicnet_tailscale_disable","description":"Disable Tailscale shortcut config.","inputSchema":{"type":"object","properties":{}}},
...
{"name":"magicnet_subscription_update","description":"Update subscriptions for sing-box, mihomo, or all.","inputSchema":{"type":"object","properties":{"target":{"type":"string","enum":["sing-box","mihomo","all"]}}}},
...
{"name":"magicnet_capture_list","description":"List capture proxy state and rules.","inputSchema":{"type":"object","properties":{}}},
{"name":"magicnet_capture_set_proxy","description":"Save capture proxy endpoint.","inputSchema":{"type":"object","properties":{"host":{"type":"string"},"port":{"type":"string"},"name":{"type":"string"}},"required":["host","port"]}},
{"name":"magicnet_capture_set_enabled","description":"Enable or disable capture mode.","inputSchema":{"type":"object","properties":{"enabled":{"type":"boolean"}},"required":["enabled"]}},
{"name":"magicnet_capture_add_app","description":"Add a package to capture scope.","inputSchema":{"type":"object","properties":{"package":{"type":"string"}},"required":["package"]}},
{"name":"magicnet_capture_remove_app","description":"Remove a package from capture scope.","inputSchema":{"type":"object","properties":{"package":{"type":"string"}},"required":["package"]}},
{"name":"magicnet_capture_add_domain","description":"Add a domain suffix to capture scope.","inputSchema":{"type":"object","properties":{"suffix":{"type":"string"}},"required":["suffix"]}},
{"name":"magicnet_capture_remove_domain","description":"Remove a domain suffix from capture scope.","inputSchema":{"type":"object","properties":{"suffix":{"type":"string"}},"required":["suffix"]}},
{"name":"magicnet_capture_apply","description":"Apply capture rules to current configs.","inputSchema":{"type":"object","properties":{}}},
{"name":"magicnet_cert_list","description":"List installed system CA certificates managed by MagicNet.","inputSchema":{"type":"object","properties":{}}},
{"name":"magicnet_cert_ensure_default","description":"Generate or install MagicNet default CA certificate.","inputSchema":{"type":"object","properties":{}}},
{"name":"magicnet_cert_install_base64","description":"Install a PEM/CRT certificate from base64 text.","inputSchema":{"type":"object","properties":{"name":{"type":"string"},"content_base64":{"type":"string"}},"required":["content_base64"]}},
{"name":"magicnet_cert_remove","description":"Remove a managed certificate filename.","inputSchema":{"type":"object","properties":{"file":{"type":"string"}},"required":["file"]}},
...
{"name":"magicnet_log_read","description":"Read the tail of a MagicNet runtime log. Sources include sing-box, mihomo, mcp, watchdog, fswatch, kernel, service, or a log filename under .log. Redaction is enabled by default.","inputSchema":{"type":"object","properties":{"source":{"type":"string"},"lines":{"type":"integer","minimum":1,"maximum":1000},"redact":{"type":"boolean"}}}},
