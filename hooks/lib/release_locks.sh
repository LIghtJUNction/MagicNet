...
release_lock_lookup() {
    ...
    case "$component" in
        ...
        jq)
            ...
            ;;
        sing-box)
            RELEASE_LOCK_REPO="SagerNet/sing-box"
            RELEASE_LOCK_TAG="v1.13.14"
            RELEASE_LOCK_ASSET="sing-box-1.13.14-android-arm64.tar.gz"
            RELEASE_LOCK_SHA256="59a4d18a4108e2f2a1bd49ca547829112712123975092d4a4bf1f443b6f3d747"
            ;;
        ecapture)
