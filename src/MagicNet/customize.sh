...
magicnet_seed_config_repository() {
  ...
  printf '%s\n' \
    ...
    'MAGICNET_SINGBOX_CONFIG_REPO_REF=fae7d46df531994b4ab8bb8c3b7531a9f7b459ff' \
    'MAGICNET_SINGBOX_CONFIG_REPO_PATH=config.json' \
    'MAGICNET_SINGBOX_CONFIG_REPO_SHA256=dad272466757b6ef349c1ff38bc68871d2e1db50d45cd5cbf099bd60939d2506' >"$_repository_file" || {
    unset _repository_file _repository_parent
    return 1
  }
