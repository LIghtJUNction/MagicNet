...
magicnet_seed_config_repository() {
  ...
  printf '%s\n' \
    ...
    'MAGICNET_SINGBOX_CONFIG_REPO_REF=83d53970b51a5819211360168c48e31a6099030e' \
    'MAGICNET_SINGBOX_CONFIG_REPO_PATH=config.json' \
    'MAGICNET_SINGBOX_CONFIG_REPO_SHA256=462f04e57270fa228c570c45d3dbf442d324663fefc23529a5e772c79092af6d' >"$_repository_file" || {
    unset _repository_file _repository_parent
    return 1
  }
