...
magicnet_install_onboarding() {
    ...
    # The browser onboarding is a deliberate install/update product entry point.
    # Existing subscription state is restored before this function and is shown
    # by the setup page; it must never suppress the browser launch on upgrades.
