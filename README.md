...
<div align="center">
  <p>
    <a href="kam.toml"><img alt="MagicNet v1.1.23" src="https://img.shields.io/badge/MagicNet-v1.1.23-31c2f2" /></a>
...
当前 release 下载页：<https://github.com/LIghtJUNction/MagicNet/releases/tag/v1.1.23>

直接下载当前模块包：<https://github.com/LIghtJUNction/MagicNet/releases/download/v1.1.23/MagicNet.zip>
